...
atm_prop_names = ['atomic_number', 'atomic_radius', 'atomic_volume', 'boiling_point', 'density',
                  ...
                  'en_allen', 'heat_of_formation', 'vdw_radius_uff',
                  'vdw_radius_mm3', 'abundance_crust', 'abundance_sea', 'en_ghosh', 'vdw_radius_alvarez',
...
def read_dataset(file_name):
    ...
    for i in range(0, data_mat.shape[0]):
        mol_graph = smiles_to_mol_graph(smiles[i], target[i])
...
def smiles_to_mol_graph(smiles, target):
    try:
