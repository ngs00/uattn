...
print('--------- mean ---------')
model = GIN(num_node_feats, num_classes, readout='mean').cuda()
...
print('--------- max ---------')
model = GIN(num_node_feats, num_classes, readout='max').cuda()
...
print('--------- attn ---------')
model = GIN(num_node_feats, num_classes, readout='attn').cuda()
...
print('--------- lstm ---------')
model = GIN(num_node_feats, num_classes, readout='lstm').cuda()
...
print('--------- add ---------')
model = GIN(num_node_feats, num_classes, readout='sum').cuda()
...
print('--------- un_attn ---------')
model = GIN(num_node_feats, num_classes, readout='uattn').cuda()
