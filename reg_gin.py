...
data_list = mconv.read_dataset('data/pdbbind.csv')
...
model = GIN(mconv.num_atm_feats, 1, readout='mean').cuda()
...
model = GIN(mconv.num_atm_feats, 1, readout='max').cuda()
...
model = GIN(mconv.num_atm_feats, 1, readout='attn').cuda()
...
model = GIN(mconv.num_atm_feats, 1, readout='lstm').cuda()
...
model = GIN(mconv.num_atm_feats, 1, readout='sum').cuda()
...
model = GIN(mconv.num_atm_feats, 1, readout='uattn').cuda()
