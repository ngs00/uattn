...
model = GAT(mconv.num_atm_feats, 1, readout='mean').cuda()
...
model = GAT(mconv.num_atm_feats, 1, readout='max').cuda()
...
model = GAT(mconv.num_atm_feats, 1, readout='attn').cuda()
...
model = GAT(mconv.num_atm_feats, 1, readout='lstm').cuda()
...
model = GAT(mconv.num_atm_feats, 1, readout='sum').cuda()
...
model = GAT(mconv.num_atm_feats, 1, readout='uattn').cuda()
