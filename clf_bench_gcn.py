...
print('--------- mean ---------')
model = GCN(num_node_feats, num_classes, readout='mean').cuda()
...
print('--------- max ---------')
model = GCN(num_node_feats, num_classes, readout='max').cuda()
...
print('--------- attn ---------')
model = GCN(num_node_feats, num_classes, readout='attn').cuda()
...
print('--------- lstm ---------')
model = GCN(num_node_feats, num_classes, readout='lstm').cuda()
...
print('--------- add ---------')
model = GCN(num_node_feats, num_classes, readout='sum').cuda()
...
print('--------- un_attn ---------')
model = GCN(num_node_feats, num_classes, readout='uattn').cuda()
